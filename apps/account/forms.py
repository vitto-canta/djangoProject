...
class RegistrationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.add_input(Submit('submit', 'Sign in', css_class="button is-dark is-uppercase"))
...
class DataForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.form_method = 'post'
        self.helper.form_action = "."
        self.helper.add_input(Submit('submit', 'Save changes', css_class="button is-dark is-uppercase"))
