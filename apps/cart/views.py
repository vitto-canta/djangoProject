    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            try:
                ...
                messages.success(request, 'The order has been concluded successfully', extra_tags='is-success')
                cart.clear()
                ...
                print(e.args)
                messages.error(request, 'There was something wrong with the payment', extra_tags='is-danger')
    else:
